...
class Circfeedpolcal(polarization.Polarization):
    ...
    def do_prepare(self):
        ...
        polleakagefield = ''
        polleakagefields = m.get_fields(intent='BANDPASS')
        try:
        ...
        polanglefield = ''
        polanglefields = m.get_fields(intent='POLANGLE,BANDPASS')
        try:
        ...
        self.do_polcal(tablesToAdd[1][0], kcrosstable=tablesToAdd[0][0], poltype=poltype, field=polleakagefield,
                       intent='CALIBRATE_BANDPASS#UNSPECIFIED',
    ...
    def do_gaincal(self, caltable, field='', spw='', combine='scan', addcallib=False):
        ...
        casa_task_args = {'vis': self.inputs.vis,
                          'caltable': caltable,
                          'field': field,
                          'intent': 'CALIBRATE_POL_ANGLE#UNSPECIFIED,CALIBRATE_FLUX#UNSPECIFIED,CALIBRATE_AMPLI#UNSPECIFIED,CALIBRATE_PHASE#UNSPECIFIED,CALIBRATE_BANDPASS#UNSPECIFIED',
                          'scan': '',
                          'spw': spw,
                          'solint': 'inf',
                          'gaintype': 'KCROSS',
